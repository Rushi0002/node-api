...
// Enable URL-encoded request parsing with extended mode
...
app.use(compression({ threshold: 1024 })); // Only compress response larger than 1KB
 ...
 * - Exit the process ith status code '0' (indicating a successful shutdown).
 */
